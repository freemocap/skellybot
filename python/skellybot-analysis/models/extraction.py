...
class ExtractedTextData(BaseModel):
    detailed_summary: str = Field("", description="An exhaustively thorough and detailed summary of the major points of this text in a bulleted outline format")
    highlights: str = Field("", description="A list of the most important points of the text, formatted as a bulleted list")
    ...
    tags: str = Field("", description="A list of tags that describe the content of the text, formatted as comma separated #lower-kabob-case")
    def __str__(self):
