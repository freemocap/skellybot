...
export class ChatbotResponseService {
  ...
  //
  // async *openaiChatCompletionStreamResponse(
  //   chatId: string,
  //   humanMessage: string,
  //   additionalArgs: any,
  //   options: StreamResponseOptions = new StreamResponseOptions(),
  ...
  //   };
  //   const { splitAt } = normalizedOptions;
  //   const chatCompletionManager =
  //     this._chatbotManagerService.getOpenAiChatCompletionManagerById(chatId);
  //
  //   const chatStream = await this._openaiChatService.createChatCompletion();
  //
  //   let fullStreamedResult = '';
  //   let subStreamResult = '';
  //   let didResetOccur = false;
