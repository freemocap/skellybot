...
var writeInferredTitleToEditor = async (
  vault,
  view,
  fileManager,
  chatFolder,
  ...
  try {
    ...
    new import_obsidian.Notice(
      '[ChatGPT MD] Error writing inferred title to editor',
    );
...
`;
  ...
  getFrontmatter(view) {
    ...
    try {
      ...
      const metaMatter =
        (_a = app.metadataCache.getFileCache(noteFile)) == null
          ? void 0
          : _a.frontmatter;
      const shouldStream =
        (metaMatter == null ? void 0 : metaMatter.stream) !== void 0
          ? metaMatter.stream
          : this.settings.stream !== void 0
            ? this.settings.stream
            : true;
      const temperature =
        (metaMatter == null ? void 0 : metaMatter.temperature) !== void 0
          ? metaMatter.temperature
          : 0.3;
      const frontmatter = {
        title:
          (metaMatter == null ? void 0 : metaMatter.title) ||
          view.file.basename,
        tags: (metaMatter == null ? void 0 : metaMatter.tags) || [],
        model:
          (metaMatter == null ? void 0 : metaMatter.model) || 'gpt-3.5-turbo',
        temperature,
        top_p: (metaMatter == null ? void 0 : metaMatter.top_p) || 1,
        presence_penalty:
          (metaMatter == null ? void 0 : metaMatter.presence_penalty) || 0,
        frequency_penalty:
          (metaMatter == null ? void 0 : metaMatter.frequency_penalty) || 0,
        stream: shouldStream,
        max_tokens:
          (metaMatter == null ? void 0 : metaMatter.max_tokens) || 512,
        stop: (metaMatter == null ? void 0 : metaMatter.stop) || null,
        n: (metaMatter == null ? void 0 : metaMatter.n) || 1,
        logit_bias:
          (metaMatter == null ? void 0 : metaMatter.logit_bias) || null,
        user: (metaMatter == null ? void 0 : metaMatter.user) || null,
        system_commands:
          (metaMatter == null ? void 0 : metaMatter.system_commands) || null,
...
${JSON.stringify(messages)}`;
      ...
      new import_obsidian3.Notice(
        '[ChatGPT MD] Error inferring title from messages',
      );
    ...
    this.addCommand({
      ...
      editorCallback: async (editor, view) => {
        try {
          ...
          if (
            !(await this.app.vault.adapter.exists(this.settings.chatFolder))
          ) {
